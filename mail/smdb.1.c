...
singleKey(smdb *sm, char **keyp, char **valuep, const char *tag1, const char *key1, int (*reduceKey)(size_t prefix, kvm_data *key))
{
	...
	strncpy(str + tag1_len, key1, key1_len);

	memset(&k, 0, sizeof (k));
	k.data = (unsigned char *) str;
	k.size = str_len;
	TextLower(k.data, k.size);
	...
	if (reduceKey == reduceMail) {
		...
		if (0 < key1_len && span == key1_len) {
			...
			if (0 < plus_sign)
				span = plus_sign;
			TextLower(memcpy(str + tag1_len + key1_len + 1, key1, span), span);
			str[str_len+1] = '@';
			str[str_len+2] = '\0';
		}
	}
...
doubleKey(smdb *sm, char **keyp, char **valuep, const char *tag1, const char *key1,  int (*reduce1)(size_t, kvm_data *), const char *tag2, const char *key2,  int (*reduce2)(size_t, kvm_data *))
{
	...
	do {
		...
		if (!singleKey(sm, keyp, valuep, k.data, key2, reduce2)) {
			rc = 0;
			break;
		}
...
smdbMailMail(smdb *sm, const char *tag1, const char *key1, const char *tag2, const char *key2, char **keyp, char **valuep)
{
	...
	span = strcspn(key1, "@");
	if (key1[span] == '@') {
		if (smdbDomainMail(sm, tag1, key1+span+1, tag2, key2, keyp, valuep) != SMDB_ACCESS_NOT_FOUND)
			goto error1;
...
main(int argc, char **argv)
{
	...
	smdbIpMail(NULL, "ip:", "", ":ip:", "", NULL, NULL);
	smdbIpMail(NULL, "ip:", "", ":domain:", "", NULL, NULL);
	smdbIpMail(NULL, "ip:", "", ":mail:", "", NULL, NULL);

	smdbDomainMail(NULL, "domain:", "", ":ip:", "", NULL, NULL);
	smdbDomainMail(NULL, "domain:", "", ":domain:", "", NULL, NULL);
	smdbDomainMail(NULL, "domain:", "", ":mail:", "", NULL, NULL);

	smdbMailMail(NULL, "mail:", "", ":ip:", "", NULL, NULL);
	smdbMailMail(NULL, "mail:", "", ":domain:", "", NULL, NULL);
	smdbMailMail(NULL, "mail:", "", ":mail:", "", NULL, NULL);

	printf("\n---- double keys ----\n\n");

	smdbIpMail(NULL, "connect:", "123.45.67.89", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbIpMail(NULL, "connect:", "123.45.67.89", ":to:", "50-235410152-fsg.com?sgsg@in137.bestintuition.com", NULL, NULL);
	smdbIpMail(NULL, "connect:", "a:b:c:d:e:f:g", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbIpMail(NULL, "connect:", "ipv6:a:b:c:d:e:f:g", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbIpMail(NULL, "connect:", "ipv6:2001:0DB8::1234:5678", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbIpMail(NULL, "connect:", "ipv6:2001:0DB8::FFFF:123.45.67.89", ":from:", "account.name@sub.domain.tld", NULL, NULL);
	smdbDomainMail(NULL, "connect:", "[123.45.67.89]", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbDomainMail(NULL, "connect:", "[ipv6:a:b:c:d:e:f:g]", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbDomainMail(NULL, "connect:", "sub.domain.tld", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail@sub.domain.tld", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbMailMail(NULL, "from:", "118599134653498-17080700031-fsg.com?asdf@bounce.superode.com", ":to:", "asdf@fsg.com", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail@[123.45.67.89]", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail@[ipv6:a:b:c:d:e:f:g]", ":to:", "account.name+detail@sub.domain.tld", NULL, NULL);

	printf("\n---- double keys with unqualified addresses ----\n\n");

	smdbIpMail(NULL, "connect:", "123.45.67.89", ":to:", "account.name+detail", NULL, NULL);
	smdbIpMail(NULL, "connect:", "a:b:c:d:e:f:g", ":to:", "account.name+detail", NULL, NULL);
	smdbIpMail(NULL, "connect:", "ipv6:a:b:c:d:e:f:g", ":to:", "account.name+detail", NULL, NULL);
	smdbIpMail(NULL, "connect:", "ipv6:2001:0DB8::1234:5678", ":to:", "account.name+detail", NULL, NULL);
	smdbIpMail(NULL, "connect:", "ipv6:2001:0DB8::FFFF:123.45.67.89", ":from:", "account.name", NULL, NULL);
	smdbDomainMail(NULL, "connect:", "[123.45.67.89]", ":to:", "account.name+detail", NULL, NULL);
	smdbDomainMail(NULL, "connect:", "[ipv6:a:b:c:d:e:f:g]", ":to:", "account.name+detail", NULL, NULL);
	smdbDomainMail(NULL, "connect:", "sub.domain.tld", ":to:", "account.name+detail", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail@sub.domain.tld", ":to:", "account.name+detail", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail@[123.45.67.89]", ":to:", "account.name+detail", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail@[ipv6:a:b:c:d:e:f:g]", ":to:", "account.name+detail", NULL, NULL);
	smdbMailMail(NULL, "from:", "account.name+detail", ":to:", "account.name+detail", NULL, NULL);

	printf("\n---- double keys (host1:host2:) ----\n\n");

	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "192.0.2.1", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "ipv6:a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "ipv6:2001:0DB8::1234:5678", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "ipv6:2001:0DB8::FFFF:123.45.67.89", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "[123.45.67.89]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "123.45.67.89", reduceIp, ":host2:", "sub.domain.tld", reduceDomain);

	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "192.0.2.1", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "ipv6:a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "ipv6:2001:0DB8::1234:5678", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "ipv6:2001:0DB8::FFFF:123.45.67.89", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "[123.45.67.89]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "a:b:c:d:e:f:g", reduceIp, ":host2:", "sub.domain.tld", reduceDomain);

	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "192.0.2.1", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "ipv6:a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "ipv6:2001:0DB8::1234:5678", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "ipv6:2001:0DB8::FFFF:123.45.67.89", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "[123.45.67.89]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "ipv6:a:b:c:d:e:f:g", reduceIp, ":host2:", "sub.domain.tld", reduceDomain);

	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "192.0.2.1", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "ipv6:a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "ipv6:2001:0DB8::1234:5678", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "ipv6:2001:0DB8::FFFF:123.45.67.89", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "[123.45.67.89]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "[123.45.67.89]", reduceDomain, ":host2:", "sub.domain.tld", reduceDomain);

	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "192.0.2.1", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "ipv6:a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "ipv6:2001:0DB8::1234:5678", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "ipv6:2001:0DB8::FFFF:123.45.67.89", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "[123.45.67.89]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain, ":host2:", "sub.domain.tld", reduceDomain);

	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "192.0.2.1", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "ipv6:a:b:c:d:e:f:g", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "ipv6:2001:0DB8::1234:5678", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "ipv6:2001:0DB8::FFFF:123.45.67.89", reduceIp);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "[123.45.67.89]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "[ipv6:a:b:c:d:e:f:g]", reduceDomain);
	doubleKey(NULL, NULL, NULL, "host1:", "sub.domain.tld", reduceDomain, ":host2:", "sub.domain.tld", reduceDomain);
